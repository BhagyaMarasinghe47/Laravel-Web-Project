...
<li class="nav-item">
    <a class="nav-link  @if(Request::segment(2) != 'home')collapsed @endif " href="{{ route('home') }}">
      <i class="bi bi-grid"></i>
      <span>Home</span>
    </a>
  </li>
  ...
  <li class="nav-item">
    <a class="nav-link   @if(Request::segment(2) != 'register')collapsed @endif " href="{{ url('panel/register') }}">
